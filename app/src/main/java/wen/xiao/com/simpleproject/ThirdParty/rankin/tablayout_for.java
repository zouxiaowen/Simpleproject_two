package wen.xiao.com.simpleproject.ThirdParty.rankin;
...
public class tablayout_for extends BaseFragment_lanjiazai {
    ...
    protected View initViews(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.layout_tablayout_for,container,false);
