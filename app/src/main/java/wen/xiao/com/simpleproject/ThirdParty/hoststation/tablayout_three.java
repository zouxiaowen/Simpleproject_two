package wen.xiao.com.simpleproject.ThirdParty.hoststation;
...
public class tablayout_three extends BaseFragment_lanjiazai {
    ...
    protected View initViews(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.layout_tablayout_three,container,false);
